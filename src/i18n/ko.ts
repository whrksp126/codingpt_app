...
const CATALOG: Record<string, string> = {
  ...
  "LAN Wi-Fi 직접 연결 서버": "LAN Wi-Fi 직접 연결 서버",
  ...
  "nth-child 경로(4단계 캡).\nfunction selOf(el){\n  var parts=[],n=el;\n  while(n&&n.nodeType===1&&parts.length": "nth-child 경로(4단계 캡).\nfunction selOf(el){\n  var parts=[],n=el;\n  while(n&&n.nodeType===1&&parts.length",
  "nth-child 경로(4단계 캡).\\\nfunction selOf(el){\\\n  var parts=[],n=el;\\\n  while(n&&n.nodeType===1&&parts.length": "nth-child 경로(4단계 캡).\\\nfunction selOf(el){\\\n  var parts=[],n=el;\\\n  while(n&&n.nodeType===1&&parts.length",
  ...
  "… (diff 가 256KB 를 넘어 잘렸어요)": "… (diff 가 256KB 를 넘어 잘렸어요)",
  "… 본문이 길어 잘렸어요": "… 본문이 길어 잘렸어요",
  "⚠ 이 PC 의 보안 지문이 QR 과 달라 암호화 열쇠는 전달하지 않았어요. PC 화면의 QR 을 다시 확인해 주세요.": "⚠ 이 PC 의 보안 지문이 QR 과 달라 암호화 열쇠는 전달하지 않았어요. PC 화면의 QR 을 다시 확인해 주세요.",
  "가끔 ChatGPT에 물어봐요": "가끔 ChatGPT에 물어봐요",
  ...
  "계정 및 기기": "계정 및 기기",
  "계획대로 진행": "계획대로 진행",
  "계획만 세우고 실행하지 않음": "계획만 세우고 실행하지 않음",
  "계획만, 변경 안 함": "계획만, 변경 안 함",
  "고급": "고급",
  "고속": "고속",
  "고정": "고정",
  "고정 해제": "고정 해제",
  ...
  "다른 기기에서 이 코드를 입력하세요": "다른 기기에서 이 코드를 입력하세요",
  ...
  "막히는 개념은 3분 레슨으로 익히고\n곧장 이어서 코딩해요.": "막히는 개념은 3분 레슨으로 익히고\n곧장 이어서 코딩해요.",
  "만들고 싶은 걸 한국어로 설명하면\nAI 에이전트가 파일을 만들고 코드를 작성해요.": "만들고 싶은 걸 한국어로 설명하면\nAI 에이전트가 파일을 만들고 코드를 작성해요.",
  "만들기": "만들기",
  "말하려면 누르세요": "말하려면 누르세요",
  "말하면, 앱이 만들어져요": "말하면, 앱이 만들어져요",
  "맞는 명령이 없습니다": "맞는 명령이 없습니다",
  "매번 승인받고 진행": "매번 승인받고 진행",
  "맨 위로 이동": "맨 위로 이동",
  "메시지 보내기": "메시지 보내기",
  "명령": "명령",
  "명령 검색": "명령 검색",
  ...
  "방금": "방금",
  "배경 테마": "배경 테마",
  "배경에 맞춰 가이드와 예제를 골라드려요.": "배경에 맞춰 가이드와 예제를 골라드려요.",
  ...
  "수정하기": "수정하기",
  "수준": "수준",
  "수준에 맞춰 설명의 깊이를 조절할게요.": "수준에 맞춰 설명의 깊이를 조절할게요.",
  "스냅샷": "스냅샷",
  ...
  "안에만 저장되고, 앱·서버는 인증 링크와 코드만 전달해요.": "안에만 저장되고, 앱·서버는 인증 링크와 코드만 전달해요.",
  "안전하게 연동": "안전하게 연동",
  "안전한 작업은 자동 진행": "안전한 작업은 자동 진행",
  "알 수 없는 상품": "알 수 없는 상품",
  "알 수 없는 오류": "알 수 없는 오류",
  ...
  "에이전트가 바꾼 코드를 모바일 IDE에서\n바로 보고, 고치고, 실행해요.": "에이전트가 바꾼 코드를 모바일 IDE에서\n바로 보고, 고치고, 실행해요.",
  ...
  "코드는 IDE에서 실시간으로": "코드는 IDE에서 실시간으로",
  "코드를 입력하세요...": "코드를 입력하세요...",
  "코드를 제출할 수 없어요.": "코드를 제출할 수 없어요.",
  "코드를 확인하고 다시 시도해 주세요.": "코드를 확인하고 다시 시도해 주세요.",
  "코딩 배우기": "코딩 배우기",
  "코딩PT": "코딩PT",
  "코딩PT로 무엇을 하고 싶으세요?": "코딩PT로 무엇을 하고 싶으세요?",
  "코딩PT를 어떻게 알게 되셨어요?": "코딩PT를 어떻게 알게 되셨어요?",
  "코멘트": "코멘트",
  "코멘트 {n}개": "코멘트 {n}개",
  "코멘트 없음": "코멘트 없음",
  "코멘트 입력…": "코멘트 입력…",
  ...
  "클라우드 준비 중…": "클라우드 준비 중…",
  "클라우드에 만들기": "클라우드에 만들기",
  "키보드 keyboard shortcut 키 조합 팔레트 command palette 재바인딩": "키보드 keyboard shortcut 키 조합 팔레트 command palette 재바인딩",
  "탈퇴": "탈퇴",
  "탈퇴 처리 중…": "탈퇴 처리 중…",
  "터미널": "터미널",
  "터미널 ": "터미널 ",
  ...
  "터미널 초기화 오류: ' + (e && e.message ? e.message : e) + '": "터미널 초기화 오류: ' + (e && e.message ? e.message : e) + '",
  "터미널 추가": "터미널 추가",
  ...
  "테마": "테마",
  "테마 글꼴 터미널 키보드 배율": "테마 글꼴 터미널 키보드 배율",
  "테마 글꼴 터미널 키보드 배율 언어 language locale 다국어 영어 english 日本語 中文": "테마 글꼴 터미널 키보드 배율 언어 language locale 다국어 영어 english 日本語 中文",
  "텍스트로 열기": "텍스트로 열기",
  "특수키 패널 크기": "특수키 패널 크기",
  ...
  "프로젝트에서 분리": "프로젝트에서 분리",
  "프로젝트에서 선택": "프로젝트에서 선택",
  "프로필 로그인 암호화 기기 로그아웃 탈퇴": "프로필 로그인 암호화 기기 로그아웃 탈퇴",
  "프롬프트": "프롬프트",
  "프리뷰": "프리뷰",
  ...
  "🔒 종단간 암호화 열쇠도 함께 전달했어요.": "🔒 종단간 암호화 열쇠도 함께 전달했어요.",
  "🚀 지금 감 잡았어!": "🚀 지금 감 잡았어!"
};
