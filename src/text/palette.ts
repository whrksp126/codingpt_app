// 팔레트·단축키 설정의 화면 문구. text/index.ts 의 규율을 따른다.
//  ⚠ PC(codingpt_pc/src/js/text/palette.js)에 같은 키·같은 뜻의 사전이 있다(대조 테스트).
//
// `cmd` 는 palette/commands.ts 의 id 와 **키 집합이 정확히 같아야 한다** — 표에 명령을 더하고
//  문구를 안 넣으면 팔레트에 빈 줄이 생긴다(대조 테스트가 이것도 잡는다).
...
export type PaletteText = {
  ...
  sc: {
    title: string; note: string; recording: string; recordingHint: string; none: string;
    reset: string; resetAll: string; conflict: string; conflictNote: string; search: string;
    modHint: string; unassigned: string; unbind: string;
  };
};

export const PALETTE_TEXT: Dict<PaletteText> = {
  "ko": {
    "open": "명령 팔레트",
  ...
  "en": {
    ...
    "placeholder": "Type a file name, or > to find a command",
    "placeholderCommand": "Search commands",
    "empty": "Nothing found",
    "emptyFiles": "No matching files in this workspace",
    "loading": "Reading the file list…",
    "truncated": "Too many files — searched a subset",
    "needWorkspace": "Open a workspace first",
    "hintCommand": "Type > for commands",
    "secOpenTabs": "Open tabs",
    "secFiles": "Files",
    "secCommands": "Commands",
    "secQuickCommands": "Saved commands",
    ...
    "cmd": {
      ...
      "find.open": "Find in current pane",
      "ws.addTerminal": "Add terminal",
      "ws.addIde": "Add IDE",
      "ws.addPreview": "Add web view",
      "ws.quickCommands": "Run a saved command",
      "ws.ports": "Show open ports",
      ...
      "notif.panel": "Open notifications",
      "notif.latestUnread": "Go to latest notification",
      "app.settings": "Open settings",
      "settings.commands": "Manage saved commands",
      "settings.shortcuts": "Keyboard shortcuts",
      "ws.select1": "Go to workspace 1",
      "ws.select2": "Go to workspace 2",
      "ws.select3": "Go to workspace 3",
      "ws.select4": "Go to workspace 4",
      "ws.select5": "Go to workspace 5",
      "ws.select6": "Go to workspace 6",
      "ws.select7": "Go to workspace 7",
      "ws.select8": "Go to workspace 8"
    },
    "sc": {
      "title": "Keyboard shortcuts",
      "note": "Select a row and press a new combination. Use “Reset” to restore the default.",
      "recording": "Press the new combination…",
      "recordingHint": "Esc to cancel · Backspace to clear",
      "none": "None",
      "reset": "Reset",
      "resetAll": "Reset all",
      "conflict": "Conflict",
      "conflictNote": "When two commands share a combination, one of them will not run.",
      "search": "Search shortcuts",
      "modHint": "Mod = ⌘ on macOS, Ctrl elsewhere",
      "unassigned": "No shortcut",
      "unbind": "Clear"
    }
  }
};
