...
//  에이전트 PC 설정(폰에서) — 게스트 OS·자원·삭제. 봉인 RPC(E2EE) 먼저, 평문 REST(`/api/daemon/desktop`, params 동봉) 폴백.
export type DesktopSettings = {
  osKind?: 'macos' | 'linux'; memGB?: number; cpu?: number; idleOffMin?: number;
